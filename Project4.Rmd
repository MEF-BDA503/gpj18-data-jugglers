...
## 2) Possible Highest Income Measure
...
maxVal <- df1 %>% summarise_all("max") %>%
  select(matches("norm")) 

minVal <- df2 %>% summarise_all("min") %>%
  select(matches("norm"))
...
## 3) Economic Volume of Companies
...
## 4) Correlation of Economic Value and Momentums
...
# 9) Conclusion
  ...
  * The banking sector is below the averages of other sectors such as heavy industry and similar company stocks. This is according to economic volume of companies and generally this banks belongs main companies which focuses on other sectors as KOC,SABANCI etc. This companies creates banks in order to supply their main job area. That's why we cannot expect that the stocks of their banks could be higher than their heavy industry companies logically.
