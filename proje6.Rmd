...
# 4) Linear Models {.tabset .tabset-fade .tabset-pills}
...
annual_average<- aggregate(norms, list(format(bist30$Dates, "%Y")), mean)
View(annual_average)
...
```{r}
plot(bist30_cluster, data=annual_average)
```
...
```{r}
fviz_cluster(bist30_cluster, data = annual_average[1:8])
```
